...
export default function Drop() {
  ...
  return (
    <div className=" h-auto w-[100%]  flex gap-5 flex-col  border-b-[2px] border-[#E7EEF6]  ">
      ...
      <div className="md:grid md:grid-cols-3  gap-4 sm:gap-0  flex flex-col mb-5  items-center   h-auto md:h-[70px] w-[100%]  ">
        <div className="relative  h-[88px] mb-2  w-[100%] md:h-[100%]   lg:w-[100%]   sm:border-r-[1px] md:border-[#E7EEF6] ">
        ...
        <div className="relative    h-[88px]  w-[100%] md:h-[100%]    lg:w-[100%] sm:border-r-[1px] md:border-[#E7EEF6] ">
          <h3 className="font-semibold mb-2 md:ml-2">Time</h3>
          <div
