...
export default function Pick() {
  ...
  return (
    <div className=" h-[150px] w-[327px] sm:h-[132px] sm:w-[582px] bg-white shadow-lg rounded-lg max-w-4xl  flex flex-col justify-center items-center">
      ...
      <div className="   h-[44px] w-[295px] sm:h-[70px]  sm:w-[486px]   ">
        {/* Options Section */}
        <div className="grid grid-cols-3 gap-2   items-center h-[44px] w-[295px] sm:h-[70px]  sm:w-[486px] ">
          {/* Locations */}
          ...
          {/* Time */}
          <div className="relative   w-[76px]  h-[100%] sm:w-[150px]  sm:border-r-[1px] sm:border-[#E7EEF6] ">
            <h3 className="text-gray-900 font-semibold mb-2">Time</h3>
            <div
              className="sm:w-[140px] m-auto sm:h-[30px]  flex justify-between items-center cursor-pointer"
